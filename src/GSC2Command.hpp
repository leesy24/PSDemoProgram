 ...
 *
 * @file:       GSC2Command.hpp - Reading sensor parameters
 *
 * @author:     CBruelle
 *
...
#ifndef GSC2COMMAND_HPP_
#define GSC2COMMAND_HPP_

#include "CommandBase.hpp"

/**
 * Class GSC2Command.hpp - Getting scans from the sensor.
 */
class GSC2Command : private CommandBase
{
    public:
    ...
    private:
        ...
        explicit
        GSC2Command(const GSC2Command& src);

        /* private assignment operator to avoid misuse */
        GSC2Command&
        operator =(const GSC2Command& src);
    ...
    public:
         ...
         */
        GSC2Command(IDataStream& theDataStream);
