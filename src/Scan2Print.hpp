#ifndef SCAN2PRINT_HPP_
#define SCAN2PRINT_HPP_
...
/**
 * Class Scan2Print.hpp - Base class for scan sequences.
 * <p>&nbsp;<p>
...
class Scan2Print
{
        ...
        explicit
        Scan2Print(const Scan2Print&);

        /* private assignment operator to avoid misuse */
        Scan2Print&
        operator =(const Scan2Print&);
    ...
    public:
         ...
         */
        Scan2Print(IDataStream& theDataStream);
