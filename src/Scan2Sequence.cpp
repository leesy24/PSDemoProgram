 ...
 */
Scan2Sequence::Scan2Sequence(IDataStream& theDataStream) :
 ...
 */
ErrorID_t
Scan2Sequence::logMessage(const char* const theMessage)
{
    string128_t lTextLine;
 ...
 */
ErrorID_t
Scan2Sequence::logError(int theError)
{
    string32_t lMessage;
    if (0 != theError)
    {
 ...
 */
ErrorID_t
Scan2Sequence::setTerminateCondition()
{
 ...
 */
void
Scan2Sequence::setTerminalLogFile(FILE* theTerminalLogName)
{
