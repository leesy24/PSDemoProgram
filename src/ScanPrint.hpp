#ifndef SCANPRINT_HPP_
#define SCANPRINT_HPP_
...
/**
 * Class ScanPrint.hpp - Base class for scan sequences.
 * <p>&nbsp;<p>
...
class ScanPrint
{
        ...
        explicit
        ScanPrint(const ScanPrint&);

        /* private assignment operator to avoid misuse */
        ScanPrint&
        operator =(const ScanPrint&);
    ...
    public:
         ...
         */
        ScanPrint(IDataStream& theDataStream);
