#ifndef SCAN2SEQUENCE_HPP_
#define SCAN2SEQUENCE_HPP_
...
/**
 * Class Scan2Sequence.hpp - Base class for scan sequences.
 * <p>&nbsp;<p>
...
class Scan2Sequence
{
        ...
        explicit
        Scan2Sequence(const Scan2Sequence&);

        /* private assignment operator to avoid misuse */
        Scan2Sequence&
        operator =(const Scan2Sequence&);
    ...
    public:
         ...
         */
        Scan2Sequence(IDataStream& theDataStream);
